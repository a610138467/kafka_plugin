...
#修改plugins/CMakeLists.txt以增加kafka_plugin插件的编译
message='add_subdirectory(kafka_plugin)'
...
message='target_link_libraries( ${NODE_EXECUTABLE_NAME} PRIVATE -Wl,${whole_archive_flag} kafka_plugin -Wl,${no_whole_archive_flag} )'
